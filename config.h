...
/* Use futexes */
// AOSP defines HAVE_FUTEX in platform/build/core/combo/include/arch/linux-arm/AndroidConfig.h, so I need to undef it here
#undef HAVE_FUTEX
...
#define SHMDIR X4DROID_DATADIR "/run/shm"
